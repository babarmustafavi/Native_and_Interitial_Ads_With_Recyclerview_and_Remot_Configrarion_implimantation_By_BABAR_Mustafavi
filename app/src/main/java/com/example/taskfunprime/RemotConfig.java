...
import com.example.taskfunprime.databinding.ActivityRemotConfigBinding;
import com.google.android.gms.tasks.OnCompleteListener;
import com.google.android.gms.tasks.Task;
import com.google.firebase.remoteconfig.FirebaseRemoteConfig;
import com.google.firebase.remoteconfig.FirebaseRemoteConfigSettings;

public class RemotConfig extends AppCompatActivity {
    ...
    private ActivityRemotConfigBinding mBinding;
    private TextView mWelcomeTextView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBinding = ActivityRemotConfigBinding.inflate(getLayoutInflater());
                ...
                .addOnCompleteListener(this, new OnCompleteListener<Boolean>() {
                    ...
                    public void onComplete(@NonNull Task<Boolean> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(RemotConfig.this, "Fetch and activate succeeded",
                                    Toast.LENGTH_SHORT).show();

                        } else {
                            Toast.makeText(RemotConfig.this, "Fetch failed",
                                    Toast.LENGTH_SHORT).show();
                        }
